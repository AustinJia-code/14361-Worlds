...
public class LeftHigh extends High {
    ...
    public void build(){
        SCORING_POSITION = new Pose2d(-27.25,-5.25, toRadians(45));
        STORAGE_POSITION = new Pose2d(-59.5, -15.1, toRadians(180));
        ...
        ScorePreload = drive.trajectorySequenceBuilder(INIT)
                ...
                .back(34)
                .splineTo(new Vector2d(SCORING_POSITION.getX()-1, SCORING_POSITION.getY()-1.75), SCORING_POSITION.getHeading())
                .build();
        ...
        StorageToScore4 = StorageToScore(WaitAtStorage4, 1, 0.5, 0);
        WaitAtScore5 = waitSequence(StorageToScore4, waitAtScore);

        ScoreToStorage5 = ScoreToStorage(WaitAtScore5, 1, 0, 0);
        WaitAtStorage5 = waitSequence(ScoreToStorage5, waitAtStorage);
        StorageToScore5 = StorageToScore(WaitAtStorage5, 1, 0, 0);
